<div class="container narrow-post">
    ...
    <div class="row">
        <div class="col-sm-16">
            ...
            <img data-src="holder.js/100%x500/#efefef:#000/text:&nbsp;" src="{{ asset(config('veer.images_path').'/'.veer_get('event.images')->shift()->img) }}" class="img-responsive">
            @else
            <img data-src="holder.js/100%x500/#CCCC99:#000/text:&nbsp;" class="img-responsive">
            @endif
            <div class="corners-post-9-title" style="color: {{ data_get($page->attributes->lists('val', 'name'), 'titlePostColor', 'auto') }}">
