<div class="container narrow-post">
    ...
    <div class="row">
        <div class="col-sm-16">
            ...
            @endif
            <div class="corners-post-5-title" style="color: {{ data_get($page->attributes->lists('val', 'name'), 'titlePostColor', 'inherit') }}">
            ...
            <div class="corners-post-5-info-group" style="color: {{ data_get($page->attributes->lists('val', 'name'), 'titlePostColor', 'inherit') }}">
