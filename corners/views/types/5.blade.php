<div class="col-sm-12 col-md-6 corners-post-id-{{ $data->id }}">
    @include($template . '.layout.excerpt-small', array('position' => 't', 'connectedId' => data_get($data->params, 'connectedPageTop')))<div class="corners-post-lists row bolshaya-content-row-grid">
        <div class="col-sm-24 text-center"><div class="img-focus">
